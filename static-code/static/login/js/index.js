document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("loginForm").addEventListener("submit", function(e) {
        ...
        fetch('https://umu-issuer:<ISSUER_PORT>/loginBackend', {
            method: 'POST',
            body: formData,
        ...
        .then(({ clientId, clientSecret }) => {
           ...
           window.location.href =  `https://umu-webwallet:<WALLET_PORT>/selectCredential`

            //window.location.href = `https://umu-webWallet:<WALLET_PORT>/`
        })
        .catch(error => {
