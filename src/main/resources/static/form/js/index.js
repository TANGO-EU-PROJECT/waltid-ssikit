...
function buildForm(template, templateName) {
    ...
    form.onsubmit = function(event) {
        ...
        fetch('https://umu-webWallet:8445/createCredential', {
            method: 'POST',
            headers: {
...
function showModal(credential) {
    ...
    modal.innerHTML = `
      <div class="modal-content">
        ...
        <div class="modal-buttons">
          ...
          <button onclick="discardCredential()">Delete</button>
        </div>
      </div>
    `;
  ...
  function saveCredential(credential, credentialName) {
    ...
    fetch('https://umu-webWallet:8445/storeCredential', {
        method: 'POST',
        body: formData
    })
    ...
    .then(text => {
        console.log(text); 
        window.location.href = "https://umu-webWallet:8445/demo"; 
