...
class IssuerCommand :
    ...
    */
    ...
    fun initialization(){
        ...
        if (local){
            DID_BACKEND = "did:fabric:633870298edaf1a990825db68bfc3234d35d85fa2333632f9192f64af98c80b0"
            KEY_ALIAS = "6a1ed26f7e6044008774509853d3121e"
        }else
        {
            keyStoreUmu.deleteAll()
