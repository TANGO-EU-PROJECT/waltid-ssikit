...
fun checkValidMetadata(metadata: Metadata): Boolean {
    ...
    val credentialIssuer = "https://umu-issuer:$ISSUER_PORT"
    val credentialEndpoint = "https://umu-issuer:$ISSUER_PORT/credential"
    val authorizationServers = "https://umu-issuer:$ISSUER_PORT/auth"
...
fun generateAuthMetadata(ISSUER_PORT: Int): String {
    ...
    return """
            { 
             ...
             "authorization_endpoint": ["https://umu-issuer:$ISSUER_PORT/auth", "https://umu-issuer:$ISSUER_PORT/auth-late","https://umu-issuer:$ISSUER_PORT/auth-ePassport" ,"https://umu-issuer:$ISSUER_PORT/code", "https://umu-issuer:$ISSUER_PORT/code-late", "https://umu-issuer:$ISSUER_PORT/code-ePassport"], 
             "token_endpoint":"https://umu-issuer:$ISSUER_PORT/token", 
...
fun generateCredentialOffer(ISSUER_PORT: Int, credentialTypes: Array<String>): String {
    val json = buildJsonObject {
        put("credential_issuer", "https://umu-issuer:$ISSUER_PORT/")
