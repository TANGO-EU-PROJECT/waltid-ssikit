...
import id.walt.model.dif.VCFormat
...
class Holder :
        ...
        val ENDPOINT_LOGIN = "https://localhost:8443/loginBackend"
        val ENDPOINT_REGISTER = "https://localhost:8443/registerBackend"
        

        // ENDPOINTS VERIFIER
        val ENDPOINT_OBTAIN_VP = "https://umu-verifier:8444/vpToken"
    ...
    suspend fun verify(client: HttpClient): String {
        ...
        val locationHeader = res.bodyAsText()
        ...
        extractPresentationDefinitionInfo(KlaxonWithConverters().toJsonString(presentationDefinition))
        ...
        val result = OIDC4VPService.postSIOPResponse_UMU(req, resp, CompatibilityMode.OIDC, "GET", url2, "requester de ejemplo", URI.create(ENDPOINT_VERIFY_VP))
    ...
    fun extractPresentationDefinitionInfo(json: String) {
        val gson = Gson()
        ...
        // Imprime las listas recopiladas para verificar
        println("Credential Types: $credentialTypes")
        println("Credential Subject Attributes: $credentialSubjectAttributes")
        println("Paths: $paths") // Imprime la lista de paths

        println(verifyCredentials(credentialTypes,paths ,credentialSubjectAttributes))
    }
